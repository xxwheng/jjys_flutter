...
+ (UIBarButtonItem *)initJingGangBackItemWihtAction:(SEL)action target:(id)target{
    ...
    UIButton *button_na = [[UIButton alloc]initWithFrame:CGRectMake(0, 30, 61, 40)];
    [button_na setImageEdgeInsets:UIEdgeInsetsMake(5, - 8, 5, 5)];
    [button_na setImage:[UIImage imageNamed:@"navRuturnBtn"] forState:UIControlStateNormal];
    [button_na setTitle:@"返回" forState:UIControlStateNormal];
